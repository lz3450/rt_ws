...
#include "rt_nav2_bt_navigator/bt_navigator.hpp"
...
: nav2_util::LifecycleNode("rt_bt_navigator", "",
...
BtNavigator::on_configure(const rclcpp_lifecycle::State & /*state*/)
{
  ...
  pose_navigator_ = std::make_unique<rt_nav2_bt_navigator::NavigateToPoseNavigator>();
  poses_navigator_ = std::make_unique<rt_nav2_bt_navigator::NavigateThroughPosesNavigator>();

  rt_nav2_bt_navigator::FeedbackUtils feedback_utils;
...
RCLCPP_COMPONENTS_REGISTER_NODE(rt_nav2_bt_navigator::BtNavigator)
